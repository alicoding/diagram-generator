...
class FlowStep(BaseModel):
    ...
    metadata: dict[str, Any] = Field(default_factory=dict, description="Rich metadata (data, notes, etc).")
...
class Flow(BaseModel):
    ...
    metadata: dict[str, Any] = Field(default_factory=dict, description="Rich metadata for the flow.")
